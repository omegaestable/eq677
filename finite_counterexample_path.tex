...
assumption.  In the column-$0$ split one can take the scalar quotient a little further:
the nonzero case is represented by $O_{11}(0,0)=1$, while in the zero case the residual
$\mathbb F_7^\times$-action can normalize $O_{11}(1,0)=1$.
