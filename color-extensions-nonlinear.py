...
def magmadef_11_0():
    ...
    m = dict()
    c = dict()
    m[(0,0)]=0; m[(0,1)]=10; m[(0,2)]=9; m[(0,3)]=7; m[(0,4)]=8; m[(0,5)]=4; m[(0,6)]=5; m[(0,7)]=2; m[(0,8)]=1; m[(0,9)]=6; m[(0,10)]=3; m[(1,0)]=10; m[(1,1)]=1; m[(1,2)]=6; m[(1,3)]=8; m[(1,4)]=5; m[(1,5)]=9; m[(1,6)]=3; m[(1,7)]=4; m[(1,8)]=7; m[(1,9)]=0; m[(1,10)]=2; m[(2,0)]=9; m[(2,1)]=6; m[(2,2)]=2; m[(2,3)]=10; m[(2,4)]=1; m[(2,5)]=3; m[(2,6)]=7; m[(2,7)]=5; m[(2,8)]=0; m[(2,9)]=4; m[(2,10)]=8; m[(3,0)]=7; m[(3,1)]=8; m[(3,2)]=10; m[(3,3)]=3; m[(3,4)]=2; m[(3,5)]=0; m[(3,6)]=4; m[(3,7)]=6; m[(3,8)]=5; m[(3,9)]=1; m[(3,10)]=9; m[(4,0)]=8; m[(4,1)]=5; m[(4,2)]=1; m[(4,3)]=2; m[(4,4)]=4; m[(4,5)]=10; m[(4,6)]=9; m[(4,7)]=0; m[(4,8)]=3; m[(4,9)]=7; m[(4,10)]=6; m[(5,0)]=4; m[(5,1)]=9; m[(5,2)]=3; m[(5,3)]=0; m[(5,4)]=10; m[(5,5)]=5; m[(5,6)]=1; m[(5,7)]=8; m[(5,8)]=6; m[(5,9)]=2; m[(5,10)]=7; m[(6,0)]=5; m[(6,1)]=3; m[(6,2)]=7; m[(6,3)]=4; m[(6,4)]=9; m[(6,5)]=1; m[(6,6)]=6; m[(6,7)]=10; m[(6,8)]=2; m[(6,9)]=8; m[(6,10)]=0; m[(7,0)]=2; m[(7,1)]=4; m[(7,2)]=5; m[(7,3)]=6; m[(7,4)]=0; m[(7,5)]=8; m[(7,6)]=10; m[(7,7)]=7; m[(7,8)]=9; m[(7,9)]=3; m[(7,10)]=1; m[(8,0)]=1; m[(8,1)]=7; m[(8,2)]=0; m[(8,3)]=5; m[(8,4)]=3; m[(8,5)]=6; m[(8,6)]=2; m[(8,7)]=9; m[(8,8)]=8; m[(8,9)]=10; m[(8,10)]=4; m[(9,0)]=6; m[(9,1)]=0; m[(9,2)]=4; m[(9,3)]=1; m[(9,4)]=7; m[(9,5)]=2; m[(9,6)]=8; m[(9,7)]=3; m[(9,8)]=10; m[(9,9)]=9; m[(9,10)]=5; m[(10,0)]=3; m[(10,1)]=2; m[(10,2)]=8; m[(10,3)]=9; m[(10,4)]=6; m[(10,5)]=7; m[(10,6)]=0; m[(10,7)]=1; m[(10,8)]=4; m[(10,9)]=5; m[(10,10)]=10;
    for i in range(n):
        for j in range(n):
            c[(i, j)] = 0 if i == j else 1
    t = [(0, 0, 0, 0,), (1, 1, 1, 1,),]
...
def magmadef_13_0():
    ...
    m = dict()
    c = dict()
    m[(0,0)]=9; m[(0,1)]=6; m[(0,2)]=2; m[(0,3)]=7; m[(0,4)]=11; m[(0,5)]=8; m[(0,6)]=4; m[(0,7)]=0; m[(0,8)]=12; m[(0,9)]=10; m[(0,10)]=1; m[(0,11)]=5; m[(0,12)]=3; m[(1,0)]=12; m[(1,1)]=2; m[(1,2)]=3; m[(1,3)]=6; m[(1,4)]=8; m[(1,5)]=7; m[(1,6)]=10; m[(1,7)]=9; m[(1,8)]=1; m[(1,9)]=0; m[(1,10)]=5; m[(1,11)]=11; m[(1,12)]=4; m[(2,0)]=5; m[(2,1)]=4; m[(2,2)]=10; m[(2,3)]=3; m[(2,4)]=6; m[(2,5)]=2; m[(2,6)]=9; m[(2,7)]=1; m[(2,8)]=11; m[(2,9)]=12; m[(2,10)]=8; m[(2,11)]=7; m[(2,12)]=0; m[(3,0)]=0; m[(3,1)]=7; m[(3,2)]=6; m[(3,3)]=8; m[(3,4)]=5; m[(3,5)]=11; m[(3,6)]=3; m[(3,7)]=10; m[(3,8)]=9; m[(3,9)]=4; m[(3,10)]=12; m[(3,11)]=1; m[(3,12)]=2; m[(4,0)]=2; m[(4,1)]=1; m[(4,2)]=5; m[(4,3)]=12; m[(4,4)]=0; m[(4,5)]=9; m[(4,6)]=8; m[(4,7)]=6; m[(4,8)]=3; m[(4,9)]=7; m[(4,10)]=4; m[(4,11)]=10; m[(4,12)]=11; m[(5,0)]=4; m[(5,1)]=11; m[(5,2)]=8; m[(5,3)]=5; m[(5,4)]=12; m[(5,5)]=1; m[(5,6)]=6; m[(5,7)]=3; m[(5,8)]=10; m[(5,9)]=2; m[(5,10)]=0; m[(5,11)]=9; m[(5,12)]=7; m[(6,0)]=6; m[(6,1)]=12; m[(6,2)]=1; m[(6,3)]=9; m[(6,4)]=10; m[(6,5)]=0; m[(6,6)]=11; m[(6,7)]=7; m[(6,8)]=2; m[(6,9)]=8; m[(6,10)]=3; m[(6,11)]=4; m[(6,12)]=5; m[(7,0)]=10; m[(7,1)]=8; m[(7,2)]=7; m[(7,3)]=11; m[(7,4)]=1; m[(7,5)]=5; m[(7,6)]=2; m[(7,7)]=4; m[(7,8)]=0; m[(7,9)]=3; m[(7,10)]=9; m[(7,11)]=12; m[(7,12)]=6; m[(8,0)]=1; m[(8,1)]=3; m[(8,2)]=4; m[(8,3)]=2; m[(8,4)]=7; m[(8,5)]=6; m[(8,6)]=0; m[(8,7)]=12; m[(8,8)]=5; m[(8,9)]=9; m[(8,10)]=11; m[(8,11)]=8; m[(8,12)]=10; m[(9,0)]=3; m[(9,1)]=5; m[(9,2)]=11; m[(9,3)]=1; m[(9,4)]=9; m[(9,5)]=12; m[(9,6)]=7; m[(9,7)]=2; m[(9,8)]=4; m[(9,9)]=6; m[(9,10)]=10; m[(9,11)]=0; m[(9,12)]=8; m[(10,0)]=11; m[(10,1)]=10; m[(10,2)]=0; m[(10,3)]=4; m[(10,4)]=2; m[(10,5)]=3; m[(10,6)]=12; m[(10,7)]=5; m[(10,8)]=8; m[(10,9)]=1; m[(10,10)]=7; m[(10,11)]=6; m[(10,12)]=9; m[(11,0)]=7; m[(11,1)]=9; m[(11,2)]=12; m[(11,3)]=0; m[(11,4)]=4; m[(11,5)]=10; m[(11,6)]=5; m[(11,7)]=8; m[(11,8)]=6; m[(11,9)]=11; m[(11,10)]=2; m[(11,11)]=3; m[(11,12)]=1; m[(12,0)]=8; m[(12,1)]=0; m[(12,2)]=9; m[(12,3)]=10; m[(12,4)]=3; m[(12,5)]=4; m[(12,6)]=1; m[(12,7)]=11; m[(12,8)]=7; m[(12,9)]=5; m[(12,10)]=6; m[(12,11)]=2; m[(12,12)]=12;
    for i in range(n):
        for j in range(n):
            c[(i, j)] = 0 if i == j else 1
    t = [(0, 0, 0, 0,), (1, 1, 1, 1,),]
...
MAGMA_DEFS = [magmadef_7_0, magmadef_9_0, magmadef_29_0, magmadef_11_0, magmadef_13_0]
